  ...
  useEffect(() => {
    async function loadProducts() {
      try {
        ...
        console.error("Gagal mengambil produk Collection:", error);
      } finally {
        setLoading(false);
      }
    }
      ...
      <section className="border-b border-neutral-200">
        <div className="mx-auto max-w-7xl px-6 py-16 md:px-10 md:py-24">
          ...
          <p className="mt-5 max-w-xl text-sm leading-7 text-neutral-500 md:text-base">
            Explore our curated collection of hijabs designed to bring
        ...
        {loading ? (
          ...
          <div className="flex min-h-[350px] flex-col items-center justify-center text-center">
            ...
            <p className="mt-3 max-w-md text-sm leading-6 text-neutral-500">
              Belum ada produk yang ditempatkan di Collection.
              Tambahkan produk melalui halaman Admin → Collection.
            </p>
